...
public class SqliteDBAcces {
    ...
    private void createTable() {
        ...
        if (nowVersion == 2) {
            //常用联系人
            mDatabase.execSQL("CREATE TABLE if not exists ContractModel (id INTEGER PRIMARY KEY AUTOINCREMENT, deviceId TEXT, contractName TEXT DEFAULT '',phoneNumber TEXT UNIQUE);");
        }
    }
